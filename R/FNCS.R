...
# ref_set <- c_counts_psy <- readRDS(file="/Users/felix/LMU/Research/1 - In Arbeit/Etzel-Seyffert/c_counts_psy_2000_2022.RDS")
...
# library(rio)
# dois <- import("/Users/felix/LMU/Research/1 - In Arbeit/Etzel-Seyffert/Study2/Data & Analysis/raw_data/doi_paper_number.xlsx")$doi

# f <- FNCS(dois=dois, ref_set = ref_set)
# plot(log(f$FNCS[f$publication_year == 2020]), f$FNPR[f$publication_year == 2020])
